...
6. Write a function to return the greatest of 3 number using if else if.

 

7. Write a function to return the grade of the given student using switch case statements
90 to 100 -> 'A'
75 to 89 -> 'B'
60 to 74 -> 'C'
50 to 59 -> 'D'
...
8. Write a function to find if a give character is vowel using switch case statements, 
    - If vowel, return 1
...
9. Write a function to accept an integer (32 bits) and operation type to do the following and 
...
10. Write a function to find the type of the character passed
    - 'A' to 'Z', return 1
